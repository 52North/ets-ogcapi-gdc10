...
<ctl:package xmlns:ctl="http://www.occamlab.com/ctl"
             ...
             xmlns:tns="http://www.opengis.net/cite/ogcapi-gdc-1.0"
             xmlns:saxon="http://saxon.sf.net/"
             xmlns:tec="java:com.occamlab.te.TECore"
             xmlns:tng="java:org.opengis.cite.ogcapigdc10.TestNGController">
  ...
  <ctl:function name="tns:run-ets-${ets-code}">
    ...
    <ctl:description>Runs the OGC API - GDC (${version}) test suite.</ctl:description>
    <ctl:code>
  ...
  <ctl:suite name="tns:ets-${ets-code}-${version}">
    <ctl:title>OGC API - GDC Conformance Test Suite</ctl:title>
    <ctl:description>Checks OGC API - GDC implementations for conformance.</ctl:description>
    ...
    <ctl:code>
      <xsl:variable name="form-data">
        <ctl:form method="POST" width="800" height="600" xmlns="http://www.w3.org/1999/xhtml">
          <h2>OGC API - GDC Conformance Test Suite</h2>
          <div style="background:#F0F8FF" bgcolor="#F0F8FF">
            <p>The implementation under test (IUT) is checked against the following specifications:</p>
            <ul>
              <li>
                <a href="https://docs.ogc.org/is/18-062r2/18-062r2.html" target="_blank">OGC API - GDC - Part 1: Core</a>
              </li>
            </ul>
          ...
          <fieldset style="background:#ccffff">
            ...
            <p>
              <label for="ogc-api-gdc-uri">
                <h4 style="margin-bottom: 0.5em">Location of the landing page</h4>
              </label>
              <input id="ogc-api-gdc-uri" name="ogc-api-gdc-uri" size="128" type="text"
                     value="" />
            </p>
            <p>
      ...
      <xsl:variable name="test-run-props">
        <properties version="1.0">
          <entry key="iut">
            <xsl:value-of select="normalize-space($form-data/values/value[@key='ogc-api-gdc-uri'])" />
          </entry>
