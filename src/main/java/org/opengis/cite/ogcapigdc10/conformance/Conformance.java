package org.opengis.cite.ogcapigdc10.conformance;

import static io.restassured.http.ContentType.JSON;
import static io.restassured.http.Method.GET;
import static org.opengis.cite.ogcapigdc10.SuiteAttribute.API_MODEL;
import static org.opengis.cite.ogcapigdc10.SuiteAttribute.IUT;
import static org.opengis.cite.ogcapigdc10.SuiteAttribute.REQUIREMENTCLASSES;
import static org.opengis.cite.ogcapigdc10.conformance.RequirementClass.CORE;
import static org.opengis.cite.ogcapigdc10.openapi3.OpenApiUtils.retrieveTestPointsForConformance;
...
import org.opengis.cite.ogcapigdc10.openapi3.TestPoint;
import org.opengis.cite.ogcapigdc10.openapi3.UriBuilder;
...
public class Conformance extends CommonFixture {
    ...
    // utrlSchema="http://beta.schemas.opengis.net/ogcapi/common/part1/0.1/core/openapi/schemas/conformance.json";
    // private static String
    // urlSchema="https://raw.githubusercontent.com/opengeospatial/ogcapi-processes/master/core/openapi/schemas/confClasses.yaml";
    private static String urlSchema =
            "http://schemas.opengis.net/ogcapi/processes/part1/1.0/openapi/schemas/confClasses.yaml";
     ...
     */
    @Test(
            description = "Implements /conf/core/conformance-success (partial)",
            groups = "A.2.3. Conformance Path /conformance",
     ...
     *
     * Abstract Test A.2.3.6.1: /conf/core/conformance-success Abstract Test
     * A.2.3.6.2: /conf/core/conformance-success Abstract Test A.2.3.6.3:
