...
import static org.opengis.cite.ogcapigdc10.SuiteAttribute.NO_OF_COLLECTIONS;
...
import org.opengis.cite.ogcapigdc10.conformance.RequirementClass;
...
public class CommonDataFixture extends CommonFixture {
    ...
    public void requirementClasses(ITestContext testContext) {
        this.requirementClasses =
                (List<RequirementClass>) testContext.getSuite().getAttribute(REQUIREMENTCLASSES.getName());
    }
