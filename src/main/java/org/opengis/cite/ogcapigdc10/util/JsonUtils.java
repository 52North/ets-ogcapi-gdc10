...
import static org.opengis.cite.ogcapigdc10.OgcApiGDC10.GEOJSON_MIME_TYPE;
...
public class JsonUtils {
     ...
     *            the json document containing the features, never
     *            <code>null</code>
     * @return the parsed id, may be <code>null</code> if no feature could be
     *         found
     */
     ...
     *
     * @param collection
     *            the collection containing the extent to parse, never
     *            <code>null</code>
    ...
    /**
     * Formats the passed string as ISO 8601 date. Example:
     ...
     * @return the formatted date, never <code>null</code>
     */
    public static String formatDateRange(ZonedDateTime beginDateTime,
     ...
     * @return the formatted date, never <code>null</code>
     */
    public static String formatDateRangeWithDuration(LocalDate beginDate,
            LocalDate endDate) {
    ...
    /**
     * Parses all links with 'type' of one of the passed mediaTypes and the
     * 'rel' property with the passed value.
     *
     * @param links
     *            list of all links, never <code>null</code>
     * @param mediaTypesToSupport
     *            a list of media types the links searched for should support,
     *            may be empty but never <code>null</code>
     * @param expectedRel
     *            the expected value of the property 'rel', never
     *            <code>null</code>
     * @return a list of links supporting one of the media types and with the
     *         expected 'rel' property, may be empty but never <code>null</code>
     */
    ...
    /**
     * Parsing the media types which does not have a link woth property 'type'
     * for.
     *
     * @param links
     *            list of links to search in, never <code>null</code>
     * @param mediaTypesToSuppport
     *            a list of media types which should be supported, never
     *            <code>null</code>
     ...
     */
    public static Map<String, Object> findLinkByRel(List<Map<String, Object>> links,
            String expectedRel) {
        if (links == null)
            return null;
        for (Map<String, Object> link : links) {
     ...
     * @return <code>true</code> if the link contains 'rel' and 'type'
    ...
    /**
     * Collects the number of all returned features by iterating over all 'next'
     * links and summarizing the size of features in 'features' array property.
     * 
     * @param jsonPath
     *            the initial collection, never <code>null</code>
     * @param maximumLimit
     *            the limit parameter value to use, if &lt;= 0 the parameter is
     *            omitted
    ...
    public static int collectNumberOfAllReturnedFeatures(JsonPath jsonPath,
            int maximumLimit) throws URISyntaxException {
    ...
    private static boolean isSameMediaType(String mediaType1,
            String mediaType2) {
    ...
    private static boolean hasLinkForContentType(List<Map<String, Object>> alternateLinks,
            String mediaType) {
    ...
    private static boolean isSupportedMediaType(Object type,
