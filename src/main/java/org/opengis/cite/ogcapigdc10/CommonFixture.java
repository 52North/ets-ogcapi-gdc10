...
public class CommonFixture {
     ...
     *      getResponseEntityAsDocument( ClientResponse response, String
     *      targetURI ) { return ClientUtils.getResponseEntityAsDocument(
     *      response, targetURI ); }
     */
     ...
     *
     * @see ClientUtils#buildGetRequest public ClientRequest buildGetRequest(
     *      URI endpoint, Map String, String qryParams, MediaType... mediaTypes
     *      ) { return ClientUtils.buildGetRequest( endpoint, qryParams,
     *      mediaTypes ); }
     */
     ...
     * 
     */
    protected boolean validateResponseAgainstSchema(String urlSchema,
            String body) {
    ...
    /**
     * Try to implement testing for A.5. Conformance Class HTML TODO: Abtract
     * Test 56: /conf/html/content Abtract Test 57: /conf/html/definition
     */
    ...
    protected Input createInput(JsonNode schemaNode,
            String id) {
    ...
    protected Output createOutput(JsonNode schemaNode,
            String id) {
